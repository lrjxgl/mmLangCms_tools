...
<form @submit="submit">
<input type="text" name="did" class="none" v-model="data.did" >
 <table class="table-add">  <tr>
						<td>id：</td>		
						<td><input class="input-text" type="text" name="id"   v-model="data.id" ></td>
						</tr>
  <tr>
						<td>content：</td>		
	...
	export default {
		...
		methods: {
			...
			getPage: function() {
				var that = this;
				that.app.get({
					url: that.app.apiHost + "/admin/forum_data/add",
					data: {
						'.did.': this.'.did.'
					},
...
content: "",
			...
			submit: function(e) {
				var that = this;
				that.app.post({
					url: that.app.apiHost + "/admin/forum_data/save",
					data: e.detail.value,
					success: function(res) {
						uni.showToast({
							title: res.message
