...
<input type="text" name="id" class="none" v-model="data.id" >
 <table class="table-add">  <tr>
  ...
  <tr>
						<td>t_userid：</td>		
						<td><input class="input-text" type="text" name="t_userid"   v-model="data.t_userid" ></td>
						</tr>
  <tr>
						<td>pm_num：</td>		
						<td><input class="input-text" type="text" name="pm_num"   v-model="data.pm_num" ></td>
						</tr>
  <tr>
						<td>type_id：</td>		
	...
	export default {
		...
		methods: {
			...
			getPage: function() {
				var that = this;
				that.app.get({
					url: that.app.apiHost + "/admin/pm_index/add",
					data: {
						'.id.': this.'.id.'
					},
...
createtime: "",
			...
			submit: function(e) {
				var that = this;
				that.app.post({
					url: that.app.apiHost + "/admin/pm_index/save",
					data: e.detail.value,
					success: function(res) {
						uni.showToast({
							title: res.message
