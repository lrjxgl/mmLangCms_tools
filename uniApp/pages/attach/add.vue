...
<input type="text" name="id" class="none" v-model="data.id" >
 <table class="table-add">  <tr>
  ...
  <tr>
						<td>文件名称：</td>		
						<td><input class="input-text" type="text" name="file_name"   v-model="data.file_name" ></td>
						</tr>
  <tr>
						<td>文件地址：</td>		
						<td><input class="input-text" type="text" name="file_url"   v-model="data.file_url" ></td>
						</tr>
  <tr>
						<td>文件大小：</td>		
						<td><input class="input-text" type="text" name="file_size"   v-model="data.file_size" ></td>
						</tr>
  <tr>
						<td>文件后缀类型：</td>		
						<td><input class="input-text" type="text" name="file_type"   v-model="data.file_type" ></td>
						</tr>
  <tr>
						<td>文件归类名称：</td>		
						<td><input class="input-text" type="text" name="file_group"   v-model="data.file_group" ></td>
						</tr>
	...
	export default {
		...
		methods: {
			...
			getPage: function() {
				var that = this;
				that.app.get({
					url: that.app.apiHost + "/admin/attach/add",
					data: {
						'.id.': this.'.id.'
					},
...
file_group: "",
			...
			submit: function(e) {
				var that = this;
				that.app.post({
					url: that.app.apiHost + "/admin/attach/save",
					data: e.detail.value,
					success: function(res) {
						uni.showToast({
							title: res.message
