...
<td>操作</td></tr>
   ...
   <td>{{item.siteid}}</td>
   <td>{{item.phone_on}}</td>
   <td>{{item.phone_reg}}</td>
   <td>{{item.phone_user}}</td>
   <td>{{item.phone_pwd}}</td>
	...
	export default {
		...
		methods: {
			...
			toggleStatus:function(item){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/admin/config/status",
					data:{
						id:item.id
					},
					success:function(res){
			...
			toggleRecommend:function(item){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/admin/config/recommend",
					data:{
						id:item.id
					},
					success:function(res){
			...
			del:function(item){
				...
				uni.showModal({
					...
					success:function(res){
						...
						that.app.get({
							url:that.app.apiHost+"/admin/config/delete",
							data:{
								id:item.id
							},
							success:function(res){
