...
<input type="text" name="id" class="none" v-model="data.id" >
 <table class="table-add">  <tr>
						<td>bday：</td>		
						<td><input class="input-text" type="text" name="bday"   v-model="data.bday" ></td>
						</tr>
  <tr>
						<td>tablename：</td>		
  ...
  <tr>
						<td>daySn：</td>		
						<td><input class="input-text" type="text" name="daySn"   v-model="data.daySn" ></td>
						</tr>
	...
	export default {
		...
		methods: {
			...
			getPage: function() {
				var that = this;
				that.app.get({
					url: that.app.apiHost + "/admin/daysn/add",
					data: {
						'.id.': this.'.id.'
					},
...
daySn: "0",
			...
			submit: function(e) {
				var that = this;
				that.app.post({
					url: that.app.apiHost + "/admin/daysn/save",
					data: e.detail.value,
					success: function(res) {
						uni.showToast({
							title: res.message
