...
<td>操作</td></tr>
   ...
   <td>{{item.title}}</td>
   <td>{{item.catid}}</td>
   <td>{{item.catid_top}}</td>
   <td>{{item.catid_2nd}}</td>
   <td>{{item.love_num}}</td>
   <td>{{item.fav_num}}</td>
	...
	export default {
		...
		methods: {
			...
			toggleStatus:function(item){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/admin/article/status",
					data:{
						id:item.id
					},
					success:function(res){
			...
			toggleRecommend:function(item){
				var that=this;
				that.app.get({
					url:that.app.apiHost+"/admin/article/recommend",
					data:{
						id:item.id
					},
					success:function(res){
			...
			del:function(item){
				...
				uni.showModal({
					...
					success:function(res){
						...
						that.app.get({
							url:that.app.apiHost+"/admin/article/delete",
							data:{
								id:item.id
							},
							success:function(res){
