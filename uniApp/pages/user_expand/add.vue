...
<form @submit="submit">
<input type="text" name="uid" class="none" v-model="data.uid" >
	...
	export default {
		...
		methods: {
			...
			getPage: function() {
				var that = this;
				that.app.get({
					url: that.app.apiHost + "/admin/user_expand/add",
					data: {
						'.uid.': this.'.uid.'
					},
...
content: "",
			...
			submit: function(e) {
				var that = this;
				that.app.post({
					url: that.app.apiHost + "/admin/user_expand/save",
					data: e.detail.value,
					success: function(res) {
						uni.showToast({
							title: res.message
