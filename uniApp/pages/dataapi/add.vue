...
<input type="text" name="id" class="none" v-model="data.id" >
 <table class="table-add">  <tr>
  ...
  <tr>
						<td>word：</td>		
						<td><input class="input-text" type="text" name="word"   v-model="data.word" ></td>
						</tr>
  <tr>
						<td>type_id：</td>		
  ...
  <tr>
						<td>equation：</td>		
						<td><input class="input-text" type="text" name="equation"   v-model="data.equation" ></td>
						</tr>
  <tr>
						<td>info：</td>		
	...
	export default {
		...
		methods: {
			...
			getPage: function() {
				var that = this;
				that.app.get({
					url: that.app.apiHost + "/admin/dataapi/add",
					data: {
						'.id.': this.'.id.'
					},
...
createtime: "",
			...
			submit: function(e) {
				var that = this;
				that.app.post({
					url: that.app.apiHost + "/admin/dataapi/save",
					data: e.detail.value,
					success: function(res) {
						uni.showToast({
							title: res.message
