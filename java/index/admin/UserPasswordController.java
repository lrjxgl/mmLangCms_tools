...
public class UserPasswordController {
	...
	@RequestMapping("/admin/user_password/show")
	public String Show(
	...
	@RequestMapping("/admin/user_password/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="userid",defaultValue="0") int userid
	) {
	...
	@RequestMapping("/admin/user_password/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="userid",defaultValue="0") int userid,
...
indata.put("salt", salt);
	...
	@RequestMapping("/admin/user_password/status")
	...
	@RequestMapping("/admin/user_password/recommend")
	...
	@RequestMapping("/admin/user_password/delete")
