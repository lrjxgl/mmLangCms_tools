...
public class DbsessionController {
	...
	public String Index(
		...
		DbsessionModel am=new DbsessionModel();
		String where=" 1 ";
		int start=per_page;
		if(limit==0){
			limit=24;
	...
	@RequestMapping("/admin/dbsession/show")
	public String Show(
	...
	@RequestMapping("/admin/dbsession/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/admin/dbsession/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
...
indata.put("data", data);
	...
	@RequestMapping("/admin/dbsession/status")
	...
	@RequestMapping("/admin/dbsession/recommend")
	...
	@RequestMapping("/admin/dbsession/delete")
