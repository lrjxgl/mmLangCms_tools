...
public class ForumDataController {
	...
	@RequestMapping("/forum_data/index")
	public String Index(
	...
	@RequestMapping("/forum_data/show")
	public String Show(
	...
	@RequestMapping("/forum_data/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("content", content);
	...
	@RequestMapping("/forum_data/status")
	...
	@RequestMapping("/forum_data/recommend")
	...
	@RequestMapping("/forum_data/delete")
