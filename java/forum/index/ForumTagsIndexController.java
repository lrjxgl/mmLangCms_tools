...
public class ForumTagsIndexController {
	...
	@RequestMapping("/forum_tags_index/index")
	public String Index(
	...
	@RequestMapping("/forum_tags_index/show")
	public String Show(
	...
	@RequestMapping("/forum_tags_index/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/forum_tags_index/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("orderindex", orderindex);
	...
	@RequestMapping("/forum_tags_index/status")
	...
	@RequestMapping("/forum_tags_index/recommend")
	...
	@RequestMapping("/forum_tags_index/delete")
