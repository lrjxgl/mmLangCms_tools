...
public class ForumGroupAdminController {
	...
	@RequestMapping("/forum_group_admin/index")
	public String Index(
	...
	@RequestMapping("/forum_group_admin/show")
	public String Show(
	...
	@RequestMapping("/forum_group_admin/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/forum_group_admin/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("status", status);
	...
	@RequestMapping("/forum_group_admin/status")
	...
	@RequestMapping("/forum_group_admin/recommend")
	...
	@RequestMapping("/forum_group_admin/delete")
