...
public class ForumImgController {
	...
	@RequestMapping("/forum_img/index")
	public String Index(
...
indata.put("imgurl", imgurl);
	...
	@RequestMapping("/forum_img/status")
	...
	@RequestMapping("/forum_img/recommend")
	...
	@RequestMapping("/forum_img/delete")
