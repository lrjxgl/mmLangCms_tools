...
public class ForumFeedsController {
	...
	@RequestMapping("/forum_feeds/show")
	public String Show(
	...
	@RequestMapping("/forum_feeds/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="id",defaultValue="0") int id
	) {
	...
	@RequestMapping("/forum_feeds/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="id",defaultValue="0") int id,
...
indata.put("fuserid", fuserid);
	...
	@RequestMapping("/forum_feeds/status")
	...
	@RequestMapping("/forum_feeds/recommend")
	...
	@RequestMapping("/forum_feeds/delete")
