...
public class ForumGroupController {
	...
	@RequestMapping("/forum_group/show")
	public String Show(
	...
	@RequestMapping("/forum_group/add")
	public String Add(
			@RequestParam(value="token",defaultValue="") String token,
			@RequestParam(value="gid",defaultValue="0") int gid
	) {
	...
	@RequestMapping("/forum_group/save")
	public String Save(
		@RequestParam(value="token",defaultValue="") String token,
		@RequestParam(value="gid",defaultValue="0") int gid,
...
indata.put("topic_num", topic_num);
	...
	@RequestMapping("/forum_group/status")
	...
	@RequestMapping("/forum_group/recommend")
	...
	@RequestMapping("/forum_group/delete")
