...
func (OpenAlipayModel) TableName() string {
	return config.TablePre + "open_alipay"
}

func OpenAlipayList(list []OpenAlipayModel) []OpenAlipayModel {
	slen := len(list)
	if slen == 0 {
		return list
	}
