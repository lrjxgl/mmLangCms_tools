...
type OpenAlipayMiniModel struct {
...
func (OpenAlipayMiniModel) TableName() string {
	return config.TablePre + "open_alipay_mini"
}

func OpenAlipayMiniList(list []OpenAlipayMiniModel) []OpenAlipayMiniModel {
	slen := len(list)
	if slen == 0 {
		return list
	}
