...
$indata["ssid"]=$request->post("ssid","");
$indata["url"]=$request->post("url","");
$indata["m"]=$request->post("m","");
$indata["a"]=$request->post("a","");
$indata["createhour"]=intval($request->post("createhour","0"));
$indata["createweek"]=intval($request->post("createweek","0"));
$indata["ip"]=$request->post("ip","");
$indata["user_agent"]=$request->post("user_agent","");
        if($id){
            $row=$fm->find($id);
