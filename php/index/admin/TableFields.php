...
$indata["tableid"]=intval($request->post("tableid","0"));
$indata["title"]=$request->post("title","");
$indata["fieldname"]=$request->post("fieldname","");
$indata["fieldtype"]=$request->post("fieldtype","");
...
$indata["optionlist"]=$request->post("optionlist","");
        if($id){
            $row=$fm->find($id);
